  ...
  Future<void> _pay() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        setState(() => _error = message.isEmpty ? 'Demo to\'lovni yakunlab bo\'lmadi. Internetni tekshiring.' : message);
      }
    } finally {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Spacer(),
                                Text('CARELINK DEMO', style: TextStyle(color: Colors.white70, fontSize: 11, fontWeight: FontWeight.w700)),
                              ],
                            ),
                            SizedBox(height: 28),
                            ...
                            Row(
                              ...
                              children: [
                                Text('DEMO KARTA', style: TextStyle(color: Colors.white70, fontSize: 12)),
                      ...
                      GlassCard(
                        cut: 14,
                        tint: AppColors.primary.withOpacity(0.05),
                        child: Row(
                          children: [
                            ...
                            const Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text('Individual CareLink', style: TextStyle(fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
                                  Text('30 kunlik AI monitoring va reminders', style: TextStyle(fontSize: 12, color: AppColors.textSecondary)),
                                ],
                              ),
                            ),
